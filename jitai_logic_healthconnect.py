...
def jitai_logic_healthconnect():
    ...
    # Query Health Connect steps
    steps_data = HealthConnect.get_health_connect_steps(
        access_token,
        project_id,
        pid,
        base_url
    ...
    daily_steps = HealthConnect.aggregate_steps_by_source(steps_data)
    ...
    # Optionally query Health Connect sleep
    sleep_data = HealthConnect.get_health_connect_sleep(
        access_token,
        project_id,
        pid,
        base_url
    )
    print(f"Retrieved {len(sleep_data)} Health Connect sleep entries.")
...
if __name__ == "__main__":
    while True:
        print("Running JITAI loop (HealthConnect)...")
        jitai_logic_healthconnect()
